...
urlpatterns = [
    ...
    path('logout/',auth_views.LogoutView.as_view(template_name="account/logged_out.html"),name="user_logout"),
    ...
    path('userinfo/',views.myself,name="user_info"),
    path('userinfo/edit/',views.myself_edit,name="user_info_edit"),
